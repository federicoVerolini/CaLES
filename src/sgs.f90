...
module mod_sgs
  ...
  subroutine cmpt_sgs(sgstype,n,ng,lo,hi,cbcvel,cbcpre,bcu,bcv,bcw,bcp,nb,is_bound,lwm,l,dl,&
    ...
    !
    allocate(bcu1%x(0:n(2)+1,0:n(3)+1,0:1), &
             bcv1%x(0:n(2)+1,0:n(3)+1,0:1), &
             bcw1%x(0:n(2)+1,0:n(3)+1,0:1), &
             bcu1%y(0:n(1)+1,0:n(3)+1,0:1), &
             bcv1%y(0:n(1)+1,0:n(3)+1,0:1), &
             bcw1%y(0:n(1)+1,0:n(3)+1,0:1), &
             bcu1%z(0:n(1)+1,0:n(2)+1,0:1), &
             bcv1%z(0:n(1)+1,0:n(2)+1,0:1), &
             bcw1%z(0:n(1)+1,0:n(2)+1,0:1))
    !
    dli(:)  = dl( :)**(-1)
    dzci(:) = dzc(:)**(-1)
    dzfi(:) = dzf(:)**(-1)
